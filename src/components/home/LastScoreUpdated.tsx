...
function ScoreElement({ score }: { score: Score }): JSX.Element {
    return (
        <Grid
            ...
            className="text-decoration-none p-2 px-3 m-1 hover-el rounded align-items-center"
