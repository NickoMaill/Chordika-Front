    ...
    return (
        <Container id="ChordEditorContainer">
            <ContentLayout isLoading={state.isDataLoading} title="" showTitle={false}>
                ...
                <Divider />
                <EditorDisplay data={state.data} onClickDeleteGroup={deleteGroup} onClickEditGroup={null} onDragStop={handleDragStop} onUpdateBar={updateBar} onUpdateChord={updateChord} />
